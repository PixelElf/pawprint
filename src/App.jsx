...
// ═══════════════════════════════════════
// PET FORM — with Lifestyle selector
// ═══════════════════════════════════════
  ...
  return(<div onClick={onClick} style={{background:V.cardBg,borderRadius:14,overflow:'hidden',cursor:'pointer',border:'1px solid '+V.border,transition:'all 0.3s',boxShadow:'0 2px 12px rgba(26,31,58,0.06)'}}
    ...
    <div style={{padding:'14px 16px 16px'}}>
      ...
      <div style={{display:'flex',gap:12,marginTop:12,paddingTop:12,borderTop:'1px solid '+V.border}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:5}}><span style={{fontSize:12}}>{lifestyleLabel(pet.lifestyle).split(' ')[0]}</span><span style={{fontFamily:F,fontSize:12,color:V.textLight,fontWeight:600}}>{pet.lifestyle==='indoor'?'Indoor':pet.lifestyle==='outdoor'?'Outdoor':'In & Out'}</span></div>
      </div>
    </div>
  </div>);
}
    ...
    <div style={{background:V.cardBg,borderRadius:16,overflow:'hidden',border:'1px solid '+V.border,boxShadow:'0 8px 30px rgba(26,31,58,0.08)'}}>
      ...
      <div style={{padding:'24px 28px 28px'}}>
        <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:8,flexWrap:'wrap'}}>
          ...
          <span style={{background:V.surface,padding:'4px 10px',borderRadius:6,fontSize:12,fontFamily:F,fontWeight:700,color:V.navy}}>{lifestyleLabel(pet.lifestyle)}</span>
        </div>
        ...
        {/* Lifestyle info box */}
        {pet.lifestyle==='indoor'&&(<div style={{marginTop:16,padding:'10px 14px',background:'rgba(201,168,76,0.08)',borderRadius:10,border:'1px solid rgba(201,168,76,0.2)'}}>
          <p style={{margin:0,fontFamily:F,fontSize:12,color:V.goldDark,fontWeight:700}}>🏠 This is an indoor pet — if spotted outside, they may need help getting home.</p>
        </div>)}

        {!isOwner&&(<>
          <div style={{marginTop:20,padding:16,background:'rgba(45,138,110,0.05)',borderRadius:12,border:'1px solid rgba(45,138,110,0.12)',display:'flex',alignItems:'center',gap:10}}><span style={{color:V.accent,flexShrink:0}}><ShieldIcon size={18}/></span><p style={{margin:0,fontSize:13,fontFamily:F,color:V.accent,lineHeight:1.5}}>Owner details are private. Tap below to reach them on WhatsApp.</p></div>
    ...
    <div style={{minHeight:'100vh',background:V.cream}}>
      ...
      <div style={{maxWidth:640,margin:'0 auto',padding:'20px 16px 90px'}}>
        ...
        {view==='browse'&&page==='browse'&&(<div style={{animation:'fadeIn 0.3s ease'}}>
          ...
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:14}}><h3 style={{margin:0,fontFamily:FD,fontSize:20,color:V.navy,fontWeight:600}}>Registered Pets in Villanova</h3><span style={{fontFamily:F,fontSize:12,color:V.textLight,fontWeight:600}}>{filtered.length} found</span></div>
